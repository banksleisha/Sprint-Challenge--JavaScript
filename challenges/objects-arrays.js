...
*/
//let lowPopulationAnimals = zooAnimals.filter(i) => {
...
const populationTotal = zooAnimals.reduce((animal, populationTotal) => {
  return animal + populationTotal.population
}, 0
);
